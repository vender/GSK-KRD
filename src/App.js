...
import { PollsList, PollsCreate, PollsEdit, PollsShow } from './components/polls';
...
const fetchResources = permissions => {
    const adminResources = [
        ...
        <Resource name="polls" options={{ label: 'Голосования' }} icon={PollIcon} list={PollsList} create={PollsCreate} edit={PollsEdit} show={PollsShow} />
    ];
